...
async function savePNG(img:any, outPath:string) {
...
export async function drawRectPNG(outPath:string, w:number, h:number, stroke:number, color:RGBA, fillOpacity:number) {
...
export async function drawCirclePNG(outPath:string, radius:number, stroke:number, color:RGBA, fillOpacity:number) {
...
export async function drawArrowPNG(outPath:string, w:number, h:number, x1:number,y1:number,x2:number,y2:number, thickness:number, headSize:number, color:RGBA) {
  ...
  function rot(vx:number, vy:number, s:number, c:number) { // rotate by +angle
